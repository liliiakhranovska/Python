...
initial_space = (5,4)
all_possible_bishop_moves = __compute_all_bishop_possible_moves (initial_space)
print (all_possible_bishop_moves)
start_space = (2,5)
print(__remove_possible_move_bishop (all_possible_bishop_moves, initial_space, start_space))
...
print (__compute_bishop_possible_moves (board, initial_space))
...
move_space = (2,7)
print (__try_to_move_bishop (initial_space, move_space, board))
